...
/*	
*	---------------------------------------------------------------------
*	SCOPE Template part: site header
*	--------------------------------------------------------------------- 
*/
?>	
		...
		<div id="navigation-container">
			<div id="navigation-inner" class="clearfix">
				...
				<nav id="site-navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
					<?php wp_nav_menu( array( 'theme_location' => 'primary', 'container_class' => 'menu-container', 'fallback_cb' => 'scope_no_menu', 'walker' => new scope_walker() ) ); ?>
				</nav><!-- #site-navigation -->
				...
				<div id="site-utility">
					<?php if( class_exists( 'WooCommerce' ) && ot_get_option('cart_button') != 'off' ) : ?>
						<div class="header_cart_wrapper">
							...
							<a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" title="<?php esc_html_e( 'View your shopping cart', 'scope' ); ?>" class="header_cart_link" >
