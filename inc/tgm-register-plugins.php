...
/*	
*	---------------------------------------------------------------------
*	SCOPE Register the required plugins for this theme
*	--------------------------------------------------------------------- 
*/
...
function theme_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => SCOPE_PLUGINS . '/js_composer.zip', // The plugin source.
		...
		array(
            'name'               => 'scope | Theme Core Extend', // The plugin name.
            'slug'               => 'core-extend', // The plugin slug (typically the folder name).
            'source'             => SCOPE_PLUGINS . '/core-extend.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
            ...
            'source'             => SCOPE_PLUGINS . '/revslider.zip', // The plugin source.
		...
		array(
            ...
            'source'             => SCOPE_PLUGINS . '/masterslider-installable.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
            ...
            'source'             => SCOPE_PLUGINS . '/easy-social-share-buttons3.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
            ...
            'source'             => SCOPE_PLUGINS . '/envato-wordpress-toolkit-master.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
    ...
    $config = array(
        'id'           => 'scope',				// Unique ID for hashing notices for multiple instances of TGMPA.
