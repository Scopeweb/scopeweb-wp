<style>
	...
	<div class="info-wrapper">
		...
		<div class="mnky_import_button" ><span><?php esc_html_e('Import demo data', 'scope')?></span></div>
	</div> 
	...
	<a class="mnky_small_button" href="<?php echo esc_url('https://www.scopeweb.nyc') ?>" target="_blank"><span><?php esc_html_e('Read documentation', 'scope')?></span></a>
	</div>
	<div class="more_column" >
	...
	<a class="mnky_small_button" href="<?php echo esc_url('themes.php?page=ot-theme-options') ?>"><span><?php esc_html_e('Customize theme', 'scope')?></span></a>
	</div>
	...
	<a class="mnky_small_button" href="<?php echo esc_url('https://www.scopeweb.nyc') ?>" target="_blank"><span><?php esc_html_e('Receive support', 'scope')?></span></a>
	</div>
	</div>
</div>