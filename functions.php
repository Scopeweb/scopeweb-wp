...
function scope_scripts() {
	...
	wp_enqueue_script( 'scope_main-js' );	
	...
	if (class_exists( 'WooCommerce' )){
		wp_register_style( 'scope_woocommerce', SCOPE_URI . '/inc/woocommerce/woocommerce.css', null, 1.0, 'all' );
	...
	wp_register_script( 'scope_sticky-sidebar', SCOPE_URI . '/js/theia-sticky-sidebar.js', array('jquery'), '', true);
