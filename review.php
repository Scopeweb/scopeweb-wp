...
<div class="review_wrapper" itemscope itemtype="http://schema.org/Review">
	...
	<div class="review_rating_wrapper clearfix" itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating">
		...
		<?php else: ?>
			<div class="rating_breakdown">
				<?php scope_review(); ?>
				<div class="rating_summary"><span class="rating_summary_value" itemprop="ratingValue"><?php echo esc_html( scope_review_sum() ); ?></span> out of <span itemprop="bestRating">10</span><meta content="0" itemprop="worstRating"></div>
			</div>
		<?php endif; ?>
	...
	<div class="rating-stars-wrapper">	
		...
		<?php else : ?>
		<span style="width:<?php echo esc_attr(scope_review_sum() * 10); ?>%"></span>
		<?php endif; ?>
		</div>
		</div>
	</div>
